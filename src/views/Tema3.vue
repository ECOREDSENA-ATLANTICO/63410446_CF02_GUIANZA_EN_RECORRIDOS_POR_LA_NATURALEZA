...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .col-lg-8
      p Se entiende por grupo cualquier número de personas (mayor de uno) ocupadas en interactuar frente a frente unas con otras en una reunión o serie de reuniones, en donde cada miembro recibe de los demás alguna impresión o percepción de la manera tan más específica que se pueda 
    .row.justify-content-start.align-items-center.mb-4
      .col-lg-4          
        .row.pe-lg-3.mb-2.fnd-1-3.align-items-center(data-aos="zoom-in")          
          .col-auto.pe-2
    ...
    .col-lg-8
      p Se aplica a grupos pequeños, compuestos por sujetos en contacto directo, colaboran entre sí y se comprometen en una acción coordinada que es parte del trabajo asignado, y de la que son responsables.

      .col-lg-4.col-md-8
        figure.mb-4
          img(src="@/assets/curso/temas/tema2/img-16.png", alt="alt")

    h3 Principales diferencias entre un grupo y un equipo
    ...
    h4 Factores por considerar al seleccionar una técnica
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      ...
      .col-lg-8
        p Los miembros del grupo suelen percibir mayor satisfacción y eficacia en grupos pequeños. Lo ideal sería contar con entre 15 y 20 participantes, aunque en la práctica los grupos suelen ser más grandes y, con suerte, no superan los 25.
        p También es importante considerar la homogeneidad y heterogeneidad de los grupos. Aunque los grupos homogéneos y cooperativos suelen alinearse mejor con ciertos objetivos, en ocasiones es necesario recurrir a la formación de grupos heterogéneos.
    ...
    h4 Papeles o roles en tareas grupales
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      .col-lg-8
        ...
        .row.pe-lg-3.mb-4.pnt.pb-3(data-aos="zoom-in")
          ...
          .col.px-0
            p.mb-0 
              span.t-g El obstructor: 
              | Tiende a presentar conductas de negatividad y terquedad, mostrando desacuerdo y oposición con razón o no.   
        .row.pe-lg-3.mb-4.pnt.pb-3(data-aos="zoom-in")
          .col-auto.pe-2.mt-1
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 
              span.t-g El que busca reconocimiento: 
              | Trabaja de diversas formas buscando atraer la atención hacia él, sobre todo hablando de sus cualidades y realizaciones personales. Se opondrá si es colocado en posiciones inferiores a las que él cree merecer.
        .row.pe-lg-3.mb-4.pnt.pb-3(data-aos="zoom-in")
          .col-auto.pe-2.mt-1
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 
              span.t-g El que se confiesa: 
              | Aprovechará la oportunidad de tener un grupo que escuche sus sentimientos, discernimientos, ideología, etc.    
      .col-lg-4.col-md-8
        figure
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      ...
      .col-lg-8
        .row.pe-lg-3.mb-4.pnt.pb-3(data-aos="zoom-in")
          ...
          .col.px-0
            p.mb-0 
              span.t-g El juguetón: 
              | No se coordina con el grupo ya que dedica su atención y esfuerzo en manifestaciones simplistas de conducta, cinismo e indiferencia, de tal modo que manipula al grupo en la medida de lo posible. 
        .row.pe-lg-3.mb-4.pnt.pb-3(data-aos="zoom-in")
          .col-auto.pe-2.mt-1
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 
              span.t-g Manipulador: 
              | Intentará reafirmar su autoridad o superioridad manipulando al grupo de ser posible, o a ciertos integrantes, ya sea vanagloriándose de sí mismo o desacreditando a los demás.
        .row.pe-lg-3.mb-4.pnt.pb-3(data-aos="zoom-in")
          .col-auto.pe-2.mt-1
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 
              span.t-g El que busca ayuda: 
              | INtentará obtener simpatía o aceptación del grupo o de algunos miembros a través de expresiones de inseguridad, confusión o subestimación.
        .row.pe-lg-3.mb-4.pnt.pb-3(data-aos="zoom-in")
          .col-auto.pe-2.mt-1
            img(src="@/assets/curso/temas/tema1/check.svg")
          .col.px-0
            p.mb-0 
              span.t-g El defensor de los intereses especiales: 
              | Hablará de la existencia de las minorías y estereotipos, generalmente ocultando sus propios prejuicios.
    ...
    h4 Liderazgo
    p El liderazgo es la capacidad de un individuo o grupo de personas para influir y guiar a un grupo de trabajo, organización o sociedad. Un líder es aquel que tiene las habilidades para motivar a sus seguidores y hacer que trabajen con entusiasmo para alcanzar sus objetivos
